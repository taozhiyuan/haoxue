...
export default class Paging extends Component {
    ...
    render(){
        ...
        return(
            <ul className="public-paging">
                <li className="icon ion-ios-arrow-back"
                    onClick= { this.pageReduce }
                ></li>
                { pagingList }
                <li className="icon ion-ios-arrow-forward"
                ...
                <style jsx global>{`
                    ul.public-paging {
                        ...
                        ul.public-paging > li:last-child {
                            margin-right: 0;
                        }
                        ul.public-paging > li:first-child:hover {
                            color: #FFF;
                            background-color: #f39e09;
                            border-color: #f39e09;
                        }
                        ul.public-paging > li:last-child:hover {
                            color: #FFF;
                            background-color: #f39e09;
                            border-color: #f39e09;
                        }
                        ul.public-paging > li.active {
                            color: #FFF;
                            background-color: #f39e09;
                            border-color: #f39e09;
                        }
